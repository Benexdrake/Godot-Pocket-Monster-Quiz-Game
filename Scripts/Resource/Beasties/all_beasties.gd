...
func get_beastie(nr:int) -> Beastie:
	...
	for b in beasties_json.data:
		if b.nr == nr:
			beastie.create(b.nr,b.name, b.image_front,b.image_back, get_array(b.descriptions), b.height, b.category, b.weight, get_array(b.genders), get_array(b.types), get_array(b.weaknesses), b.hp, b.attack, b.defense, b.specialAttack, b.specialDefense, b.speed)
			return beastie
	return null
